    ...
    try:
        ...
        if file_data.obs_name is not None:
            ...
            try:
                ...
                observation = await create_observation(observation_data=Observation(obs_name=file_data.obs_name, file_name=file_data.filename, fits_header=FitsHeader.from_dict(file_data.fits_header)), token=token)
